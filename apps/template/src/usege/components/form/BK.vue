...
import * as c from '@dfsj/components'
import {reactive, ref} from 'vue'
import {CheckboxOption, Form, FormSchema, RadioOption, SelectOption} from '@dfsj/components/src/components/Form'
import {
  ElButton,
  ElCheckbox,
  ElCheckboxButton,
...
<template>
	<div class="h-full w-full bg-white">
		<Form :schema="schema" label-width="auto" :label-position="'top'" />
	</div>
</template>
