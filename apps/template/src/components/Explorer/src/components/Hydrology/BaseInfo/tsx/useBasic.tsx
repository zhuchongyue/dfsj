    ...
    const schema = shallowRef<DescriptionsSchema[]>([
...

        {
            ...
            slots: {
                default: () => {
                    return (
                        <ElFormItem prop="riverCodeMo">
                            {disabled.value ?  valueOfOptions(form.riverCodeMo ,[]) : <ElInput v-model={form.riverCodeMo}/>}
                        </ElFormItem>
                    )
                }
            }
        },
        {
            ...
            slots: {
                default: () => {
                    return (
                        <ElFormItem prop="riverSegCode">
                            {disabled.value ?  valueOfOptions(form.riverSegCode ,[]) : <ElInput v-model={form.riverSegCode}/>}
                        </ElFormItem>
                    )
                }
            }
