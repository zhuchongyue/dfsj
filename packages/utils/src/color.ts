 ...
 * @returns  String      -类似#ff00ff
 * @param {unknown} r  - 颜色r值
 * @param {unknown} g  - 颜色g值
 * @param {unknown} b  - 颜色b值
 */
 ...
 */
export const mixColor = (color1: string, color2: string, weight: number = 0.5): string => {
	let color = '#'
	for (let i = 0; i <= 2; i++) {
