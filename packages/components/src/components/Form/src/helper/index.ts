...
import {getLabel} from '../../../../helper/lang';
...
export const setTextPlaceholder = (schema: FormSchema): PlaceholderModel => {
  ...
  if (textMap.includes(schema?.component as ComponentNameEnum)) {
    return {
      placeholder: getLabel('common.inputText'),
    };
  }
  if (selectMap.includes(schema?.component as ComponentNameEnum)) {
    ...
    if (
      ...
      return {
        startPlaceholder: getLabel('common.startTimeText'),
        endPlaceholder: getLabel('common.endTimeText'),
        rangeSeparator: '-',
      };
    } else {
      return {
        placeholder: getLabel('common.selectText'),
      };
    }
  }
  return {};
